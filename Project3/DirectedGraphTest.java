...
public class DirectedGraphTest
{
    ...
    public void testAddNode1(){
        ...
        graph.addNode(1, "none",0);                                                                       //add the same node twice
        graph.addNode(1, "none",0);
       
        ArrayList<Node<Integer>> nodes = graph.getNodes();                         //convert list of nodes into array
    ...
    public void testAddNode2(){
        ...
        graph.addNode(1, "none",0);
        graph.addNode(2, "none",0);
        graph.addNode(3, "none",0);
    ...
    public void testAddEdge2(){
        ...
        Node<Integer> start = graph.find(1);                              //start node
    ...
    public void testAddEdge3(){
        ...
        Node<Integer> start = graph.find(1); 
    ...
    public void testGetNeighbor2(){
        DirectedGraph<Integer> graph = new DirectedGraph<Integer>();                    //create graph
        graph.addNode(1, "none",0);                                                               //create and add nodes and edges
        graph.addNode(2, "none",0);   
        graph.addNode(3, "none",0);
