...
public class StationListTest
{
    ...
    @Test
    public void testAdd(){                                                      //add stations to list
    ...
    @Test 
    public void testFindMin1(){                                                  //find min of an empty list
        StationList stations = new StationList(new RandomGaussian(100.0,5.0,4328472));  
        for (int i = 0; i <3; i++){
    ...
    public void testFindMin2(){
        StationList stations = new StationList(new RandomGaussian(100.0,5.0,4328472));
        for (int i = 0; i <3; i++){
            ArrayList<Double> num = new ArrayList<Double>();                    //create a nonempty list of numbers
            num.add(5.0);
            num.add(3.2);
            num.add(1.8);
            num.add(9.0);
            int result = stations.findMin(num);                                 //find min
